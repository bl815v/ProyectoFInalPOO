...
/**
 * PanelAbono es el panel para que el usuario pueda abonar a su deuda desde la interfaz grafica.
 * Contiene todos los componentes necesarios para que el usuario logre hacer esta actividad.
 ...
 * 580px ancho, 280px largo, BoxLayout en el eje Y, por defecto no es visible.
 */
 ...
 * Relacionados al saldo pendiente, la cantidad de dinero a abonar, botones abonar y cancelar.
 */
...
/**
 * Obtiene el JLabel que funciona como un titulo antes de indicar el dinero que debe.
 * Estandar.labelGris(). Texto por defecto: "Saldo Pendiente:".
...
/**
 * Cambia el JLabel que funciona como un titulo antes de indicar el dinero que debe.
...
/**
 * Obtiene el JLabel que indica el dinero que debe.
...
/**
 * Obtiene el JLabel que funciona como un titulo antes de indicar el dinero a abonar.
 * Estandar.labelNegro(). Texto por defecto: "Ingrese la cantidad de dinero a abonar:".
 * @return JLabel que aparece arriba del JTextField en el que el usuario ingresa el valor a abonar.
 */
	public JLabel getEingrese() {
		return eingrese;
	}
/**
 * Cambia el JLabel que funciona como un titulo antes de indicar el dinero a abonar.
...
/**
 * Obtiene el JLabel auxiliar que está antes del JTextField en el que el usuario ingresa el valor a abonar.
 * Estandar.labelNegro(). Texto por defecto: "$ "
...
/**
 * Cambia el JLabel auxiliar que está antes del JTextField en el que el usuario ingresa el valor a abonar.
...
/**
 * Obtiene el JLabel auxiliar que está después del JTextField en el que el usuario ingresa el valor a abonar.
 * Estandar.labelNegro(). Texto por defecto: " pesos".
...
/**
 * Cambia el JLabel auxiliar que está después del JTextField en el que el usuario ingresa el valor a abonar.
...
/**
 * Obtiene el JTextField en el que el usuario ingresa el valor a abonar.
 * Por defecto es de 400px ancho, 35px largo, fuente Arial a 18px.
...
/**
 * Obtiene el JButton para abonar el valor que el usuario ingreso en el JTextField.
 * Estandar.boton("Abonar"). Comando de acción: "bABONAR".
...
/**
 * Cambia el JButton para abonar el valor que el usuario ingreso en el JTextField.
...
/**
 * Obtiene el JButton para salir del panel.
 * Estandar.boton("Cancelar"). Comando de acción: "bCANCELARABONO".
