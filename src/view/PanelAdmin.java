...
/**
 * Crea el pane e inicializa  sus componentes
 * 680px ancho,520px largo,
 */
	public PanelAdmin() {
         ...
         * Relacionados al Informe,usuarios,solicitudes y sedes
         */
	...
	/**
         * Inicializa el panel para ver los informes
         * Relacionados a el informe en formato PDF y sus estadisticas
         */
	...
	/**
         * Inicializa el panel para ver los usuarios
         * Relacionados a la gestion de los usuarios existentes
         */
	...
	/**
         * Inicializa el panel para ver las Solicitudes
         * Relarcionados a la solicitudes echas y su gestion
         */
	...
	/**
         * Innicializa el panel de sedes
         * Relacionado a las sedes existentes y su gestion(agregar y eliminar)
         *
         */
...
/**
 * Cambia el JLabe con el titulo por otro JLabel,es lo primero que aparece en el pane
 ...
 */
    ...
    /**
     * Método de establecimiento para cuadroUsuarios (panel de información de usuarios).
    ...
    /**
     * Método de establecimiento para cuadroInformes (panel de información de informes).
    ...
    /**
     * Método de obtención para cuadroSolicitudes (panel de información de solicitudes).
    ...
    /**
     * Método de establecimiento para cuadroSolicitudes (panel de información de solicitudes).
