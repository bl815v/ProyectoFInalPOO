...
/**
 * La clase PanelHistorialCompras representa un JPanel para mostrar el historial
 * de compras. Incluye un título, una tabla para mostrar los detalles de las
 * compras y un botón para volver atrás.
 * 
...
public class PanelHistorialCompras extends JPanel {
	...
	/**
	 * Constructor para PanelHistorialCompras. Inicializa el diseño, tamaño y
