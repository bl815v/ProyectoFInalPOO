...
/**
 * PanelLogin es el panel en el que se puede iniciar sesion. Contiene todos los
 * componentes necesarios para iniciar sesion con su usuario y clave.
 * 
...
public class PanelLogin extends JPanel {
	...
	/**
	 * Crea el panel e inicializa sus componentes. 270px ancho, 400px largo,
	 * BoxLayout en el eje Y, por defecto es visible.
	 */
	public PanelLogin() {
	...
	/**
	 * Inicializa los componentes del panel. Relacionados a iniciar sesion con el
	 * usuario y clave
	 */
	...
	/**
	 * Obtiene el JLabel que funciona como un subtitulo para indicar que se debe
	 * ingresar el usuario en el siguiente JTextField. Fuente Arial a 14px. Texto
	 * por defecto: "Ingrese su nombre de usuario (alias):".
	 * 
	...
	/**
	 * Cambia el JLabel que funciona como un subtitulo para indicar que se debe
	 * ingresar el usuario en el siguiente JTextField.
	 * 
	...
	/**
	 * Obtiene el JLabel que funciona como un subtitulo para indicar que se debe
	 * ingresar la clave en el siguiente JTextField. Fuente Arial a 14px. Texto por
	 * defecto: "Ingrese su clave:".
	 * 
	...
	/**
	 * Cambia el JLabel que funciona como un subtitulo para indicar que se debe
	 * ingresar la clave en el siguiente JTextField.
	 * 
	...
	/**
	 * Obtiene el JLabel que funciona como un titulo para indicar que se debe
	 * ingresar el usuario en el siguiente JTextField. Estandar.labelNegro(). Texto
	 * por defecto: "Usuario".
	 * 
	 * @return JLabel para indicar que debe ingresar el usuario
	 */
	...
	/**
	 * Cambia el JLabel que funciona como un titulo para indicar que se debe
	 * ingresar el usuario en el siguiente JTextField.
	 * 
	...
	/**
	 * Obtiene el JLabel que funciona como un titulo para indicar que se debe
	 * ingresar la clave en el siguiente JTextField. Estandar.labelNegro(). Texto
	 * por defecto: "Clave".
	 * 
	 * @return JLabel para indicar que debe ingresar la clave
	 */
	...
	/**
	 * Obtiene el JLabel que explica al boton para registrarse que se ubica debajo
	 * del JLabel. Fuente Arial a 14px. Texto por defecto: "No tienes una cuenta?".
	 * 
	...
	/**
	 * Cambia el JLabel que explica al boton para registrarse que se ubica debajo
	 * del JLabel.
	 * 
	...
	/**
	 * Obtiene el JTextField en el que el usuario ingresa su usuario. Por defecto es
	 * de 300px ancho, 30px largo, fuente Arial a 13px.
	 * 
	...
	/**
	 * Obtiene el JPasswordField en el que el usuario ingresa su clave. Por defecto
	 * es de 300px ancho, 30px largo, fuente Arial a 13px.
	 * 
	...
	/**
	 * Obtiene el JButton para iniciar sesion y abrir la ventana cliente,
	 * administrador o pareja. Estandar.boton("Entrar ->"). Comando de acción:
	 * "bLOGIN".
	 * 
	...
	/**
	 * Cambia el JButton para iniciar sesion y abrir la ventana cliente,
	 * administrador o pareja.
	 * 
