...
/**
 * PanelCliente es el panel con el menu principal del cliente en la interfaz grafica.
 * Contiene todos los componentes necesarios para que el cliente pueda ver su cupo disponible, su saldo pendiente, 
 * botones para comprar, ver sus parejas, su historial de compras y pedir un sobrecupo.
 ...
 * 680px ancho, 520px largo, BorderLayout, por defecto es visible.
 */
	public PanelCliente() {
 ...
 * Relacionados al cupo disponible, saldo pendiente, botones comprar, ver parejas, historial de compras y pedir sobrecupo.
 */
...
/**
 * Obtiene un JLabel vacio.
 * Util para generar espacios en blanco en la interfaz grafica facilmente.
 * Texto por defecto: " ".
...
/**
 * Cambia el JLabel vacio.
 * NO RECOMENDABLE, porque su funcion es generar espacios en blanco en la interfaz grafica facilmente.
 ...
 * Estandar.labelNegro(). Texto por defecto: "Bienvenido, ".
 * Recomendado cambiar el texto para agregarle el nombre del usuario que inicio sesion.
...
/**
 * Obtiene el JLabel que funciona como un titulo para indicar al usuario que lo siguiente será su cupo disponible.
 * Estandar.labelGris(). Texto por defecto: "Cupo Disponible:".
...
/**
 * Cambia el JLabel que funciona como un titulo para indicar al usuario que lo siguiente será su cupo disponible.
...
/**
 * Obtiene el JLabel que funciona como un titulo para indicar al usuario que lo siguiente será su saldo Pendiente.
...
/**
 * Cambia el JLabel que funciona como un titulo para indicar al usuario que lo siguiente será su saldo Pendiente.
...
/**
 * Obtiene el JButton para cerrar sesion, salir de la ventana y volver a la ventana para iniciar sesion.
 * Estandar.boton("Cerrar sesion"). Comando de acción: "bCERRARSESION".
...
/**
 * Cambia el JButton para cerrar sesion, salir de la ventana y volver a la ventana para iniciar sesion.
