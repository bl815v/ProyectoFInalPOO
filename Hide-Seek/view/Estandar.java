 ...
 * Titulos, subtitulos, botones, separadores, fondo y demas funciones utiles en las ventanas y paneles.
 * 
...
/**
 * Previene que se cierre la ventana por error.
 * Advierte que se perderan todos los datos si se cierra el programa en una ventana emergente si/no. 
...
/**
 * Crea un JButton azul.
 * Boton color azul casi celeste, texto blanco, fuente Arial a 18px.
...
/**
 * Crea un JButton sin fondo.
 * Boton sin fondo y sin bordes, texto color azul casi celeste, fuente Arial a 14px.
 * @param nombre Texto que tiene el boton
...
/**
 * Crea un JSeparator blanco.
 * Tamaño: 1px ancho, 30px de largo.
...
/**
 * Crea un JSeparator azul comunmente usado debajo de los JTextField transparentes.
 * Tamaño: 500px ancho, 30px largo. Color azul casi celeste.
...
/**
 * Crea un JSeparator azul comunmente usado debajo de los JTextField transparentes, del tamaño ingresado.
 * @param x Ancho en pixeles que tendra el JSeparator
 * @param y Largo en pixeles que tendra el JSeparator
...
/**
 * Hace que el panel ingresado siempre se encuentre en el centro de la ventana ingresada.
 * El panel estará ubicado en el centro aunque se cambie el tamaño de la ventana 
...
/**
 * Espera a que el JTextField ingresado deje de estar vacio.
 * Vuelve al color y texto original del JLabel ingresado cuando el JTexTField deje de estar vacio.
 * @param campo JTextField que se revisa
 * @param esub JLabel con el texto que indica lo que se debe ingresar en el JTextField
 * @param texto Texto que tiene el JLabel que indica lo que se debe ingresar en el JTextField
 */
...
/**
 * Espera a que el JComboBox ingresado deje de tener la opcion vacia seleccionada.
 * Vuelve al color y texto original del JLabel ingresado cuando el JComboBox deje de tener la opcion vacia seleccionada.
 * @param comboBox JComboBox que se revisa
 * @param esub JLabel con el texto que indica lo que se debe ingresar en el JComboBox
 * @param texto Texto que tiene el JLabel que indica lo que se debe ingresar en el JComboBox
 */
...
/**
 * Obtiene el color principal de la clase Estandar.
 * Por defecto es un color azul moderadamente claro, casi celeste, con matices suaves. RGB(84, 160, 227) HEX(ffbae5).
...
/**
 * Cambia el color principal de la clase Estandar.
 * Este es el color que comparten la mayoria de metodos de la clase Estandar.
 ...
 * Previamente se debe seleccionar el fondo en el metodo SeleccionarFondo() de esta misma clase.
 ...
 * Una alternativa ruda al metodo SeleccionarFondo() si es que el JLabel ingresado ya tiene un Icon. 
